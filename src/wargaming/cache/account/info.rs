...
impl AccountInfoCache {
    ...
    #[instrument(level = "debug", name = "AccountInfoCache::get", skip_all, fields(account_id = account_id))]
    ...
    #[instrument(level = "debug", name = "AccountInfoCache::put", skip_all, fields(account_id = account_info.base.id))]
