        ...
        tr {
            ...
            th {
                a data-sort="true-win-rate-mean" {
                    span.icon-text.is-flex-wrap-nowrap {
                        span { abbr title="Процент побед, скорректированный на число боев, CI 96%" { "Процент побед (интервал)" } }
                    }
                }
            }
            ...
            th {
                a data-sort="expected-wins-per-hour" {
                    span.icon-text.is-flex-wrap-nowrap {
                        span { abbr title="Число побед в час, скорректированное на число проведенных боев, CI 96%" { "Победы в час (интервал)" } }
                    }
                }
            }
            ...
            th {
                a data-sort="true-gold" {
                    span.icon-text.is-flex-wrap-nowrap {
                        span { abbr title="Доходность золотого бустера за бой, скорректированная на число проведенных боев, CI 96%" { "Ожидаемое золото" } }
                    }
                }
            }
